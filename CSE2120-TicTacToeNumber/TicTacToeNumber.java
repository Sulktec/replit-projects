...
class TicTacToeNumber {
    ...
    public static int[] playerChoiceAndCheck(String[][] map, String character) {
        ...
        while (falseStatement == true) {
            ...
            System.out.println("\n\n\n" + character + " choose your place");
            userChoice = myObj.nextLine();



            numberExist = doesNumberExist(map, userChoice);



            int index = 0;

            while (index < 9 && numberExist == true) {
                String numberString = "" + index;


                if (userChoice.equals(numberString)) {
                    characterPos = findPos(map, userChoice);
    ...
    public static boolean doesNumberExist(String[][] column, String userChoice) {
        boolean numberExist = false;
        int indexColumn = 0;
        int indexRow = 0;
        ...
        while (indexColumn < column.length) {
            ...
            while (indexRow < column[indexColumn].length) {
                ...
                if (column[indexColumn][indexRow].equals(userChoice)) {
    ...
    public static int[] findPos(String[][] column, String userChoice) {
        int[] characterPos = { 0 , 0 };
        ...
        while (indexColumn < column.length) {
            ...
            while (indexRow < column[indexColumn].length) {
                ...
                if (column[indexColumn][indexRow].equals(userChoice)) {
                    ...
                    characterPos[0] = indexRow;
                    characterPos[1] = indexColumn;
